...
public record UserController(UserService userService) {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "UserDto created successfully"),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "UserDto updated successfully"),
            @ApiResponse(responseCode = "404", description = "UserDto not found"),
            @ApiResponse(responseCode = "422", description = "Invalid user data provided")
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "UserDto deleted successfully"),
            @ApiResponse(responseCode = "404", description = "UserDto not found")
    })
